...
class DaftarProdukView extends StatelessWidget {
  ...
  // Menggunakan ImageCacheManager instance
  ...
  String _getImageUrl(Map<String, dynamic> produk) {
    ...
    try {
      ...
      // Contoh: Jika menggunakan device fisik, gunakan IP komputer Anda
      // Jika menggunakan emulator, gunakan 10.0.2.2
      final baseUrl = '10.0.2.2'; // Ganti dengan IP server Anda

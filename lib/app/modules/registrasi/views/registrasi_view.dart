...
class RegistrasiView extends GetView<RegistrasiController> {
  final RegistrasiController controller = Get.put(RegistrasiController()); // Initialize the registration controller
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Email input field
                TextField(
                  controller: controller.emailController, // Use controller for email
                ...
                Obx(() => TextField(
                  controller: controller.passwordController, // Use controller for password
                ...
                Obx(() => TextField(
                  controller: controller.confirmPasswordController, // Use controller for confirm password
